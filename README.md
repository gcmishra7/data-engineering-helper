...
| AI / LLM Data Engineer | `11-ai-data-engineering/01-rag-fundamentals/` → `11-ai-data-engineering/04-mcp-and-ai-tools/` |
...
└── 11-ai-data-engineering/            # RAG, vector DBs, unstructured pipelines, MCP, LLMOps
```
